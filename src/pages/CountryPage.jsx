    ...
    return (
        <div>
            ...
            <section className="bg-white py-12">
                ...
                <div className="max-w-7xl mx-auto my-14 grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-4">
                    <img src={data.map} alt={data.name} className="rounded-2xl shadow-lg w-full h-96 object-cover" />
                    ...
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        <div className="mt-10 grid grid-cols-1 md:grid-cols-4 gap-6">
                            {data.highlights.map((place, idx) => (
                                <div key={idx} className="rounded-2xl shadow-md px-4 py-6 bg-white hover:shadow-xl transition flex gap-2">
